...
#ifndef C_TREES_TEST_TREE_NUMBEROFLEAVES_H
#define C_TREES_TEST_TREE_NUMBEROFLEAVES_H

void test_tree_numberofleaves();

#endif //C_TREES_TEST_TREE_NUMBEROFLEAVES_H
